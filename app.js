...
const KNOWLEDGE = [
  {
    ...
    ar:{title:'من هنا نعلم',desc:'الإسلام ليس مجرد عبادات وطقوس، بل هو نظام شامل يحكم كل جوانب الحياة: العقيدة والعبادة والأخلاق والمعاملات والحكم. هذا ما يثبته الشيخ الغزالي في رده العلمي.',misconception:'الدين شأن شخصي فقط ولا علاقة له بالدولة',response:'الإسلام جاء بنظام متكامل: عقيدة وشريعة وأخلاق ودولة. فصل الدين عن الحياة يناقض جوهر الرسالة الإسلامية',evidence:'شَرَعَ لَكُم مِّنَ الدِّينِ مَا وَصَّىٰ بِهِ نُوحًا — الشورى ٤٢: ١٣'},
