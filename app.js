...
const KNOWLEDGE = [
  {
    ...
    ar:{title:'من هنا نعلم',desc:'كتبه الغزالي عام ١٩٥٠ رداً نقطياً على كتاب خالد محمد خالد "من هنا نبدأ" الذي دعا إلى فصل الدين عن الدولة. يثبت الغزالي أن الإسلام نظام شامل: عقيدة وعبادة وأخلاق ومعاملات وحكم. خالد نفسه تراجع لاحقاً في كتابه "الدولة في الإسلام".',misconception:'الدين شأن شخصي فقط ولا علاقة له بالدولة',response:'يؤكد الغزالي: الإسلام جاء بنظام متكامل: عقيدة وشريعة وأخلاق ودولة. فصل الدين عن الحياة يناقض جوهر الرسالة الإسلامية',evidence:'شَرَعَ لَكُم مِّنَ الدِّينِ مَا وَصَّىٰ بِهِ نُوحًا — الشورى ٤٢: ١٣'},
    en:{title:'This Is Where We Learn',desc:'Al-Ghazali affirms: Islam is not merely rituals and worship, but a comprehensive system governing all aspects of life: creed, worship, ethics, transactions, and governance. This is what Sheikh al-Ghazali proves in his scholarly response.',misconception:'Religion is a purely personal matter with no relation to the state',response:'Al-Ghazali affirms: Islam came as an integrated system: creed, law, ethics, and governance. Separating religion from life contradicts the very essence of the Islamic message',evidence:'He has ordained for you the same religion He enjoined upon Noah — Ash-Shura 42:13'},
    fr:{title:'C\'est Ici Que Nous Apprenons',desc:'Al-Ghazali affirme: L\'Islam n\'est pas simplement des rituels et des cultes, mais un système global qui régit tous les aspects de la vie : croyance, culte, éthique, transactions et gouvernance. C\'est ce que le Cheikh al-Ghazali prouve dans sa réponse savante.',misconception:'La religion est une affaire purement personnelle sans rapport avec l\'État',response:'Al-Ghazali affirme: L\'Islam est venu comme un système intégré : croyance, loi, éthique et gouvernance. Séparer la religion de la vie contredit l\'essence même du message islamique',evidence:'Il vous a prescrit en matière de religion ce qu\'Il avait enjoint à Noé — Ash-Shura 42:13'}
  },
  {
    id:2, emoji:'⚖️', category:'governance',
    ar:{title:'العدل أساس الحكم',desc:'يؤكد الغزالي: الحكم في الإسلام مبني على العدل المطلق. لا يجوز للحاكم أن يظلم ولو كان المظلوم غير مسلم. العدل فريضة لا فضيلة اختيارية.',misconception:'الحكم الإسلامي استبداد ديني',response:'يؤكد الغزالي: الإسلام سبق العالم في تقييد سلطة الحاكم. الحاكم في الإسلام خادم للأمة لا سيدها، ومقيد بالشريعة والشورى',evidence:'إِنَّ اللَّهَ يَأْمُرُ بِالْعَدْلِ وَالْإِحْسَانِ — النحل ١٦: ٩٠'},
    en:{title:'Justice Is the Foundation of Governance',desc:'Al-Ghazali affirms: Governance in Islam is built upon absolute justice. A ruler may not oppress anyone, even non-Muslims. Justice is an obligation, not an optional virtue.',misconception:'Islamic governance is religious tyranny',response:'Al-Ghazali affirms: Islam preceded the world in restricting the ruler\'s power. The ruler in Islam is a servant of the community, not its master, and is bound by divine law and consultation',evidence:'Indeed, God commands justice and good conduct — An-Nahl 16:90'},
    fr:{title:'La Justice, Fondement de la Gouvernance',desc:'Al-Ghazali affirme: La gouvernance en Islam est fondée sur la justice absolue. Un dirigeant ne peut opprimer personne, même les non-musulmans. La justice est une obligation, pas une vertu optionnelle.',misconception:'La gouvernance islamique est une tyrannie religieuse',response:'Al-Ghazali affirme: L\'Islam a précédé le monde en limitant le pouvoir du dirigeant. Le dirigeant en Islam est un serviteur de la communauté, pas son maître, et il est lié par la loi divine et la consultation',evidence:'Certes, Dieu commande la justice et la bienfaisance — An-Nahl 16:90'}
  },
  {
    id:3, emoji:'🤝', category:'governance',
    ar:{title:'الشورى منهج إسلامي',desc:'يؤكد الغزالي: الشورى ليست مجرد توصية بل فريضة إلهية. الحاكم المسلم ملزم بمشاورة أهل العلم والخبرة. الاستبداد مرفوض في الإسلام رفضاً قاطعاً.',misconception:'الإسلام لا يعرف الديمقراطية',response:'يؤكد الغزالي: الشورى أسبق من الديمقراطية الحديثة بأربعة عشر قرناً. الفرق أن الشورى تستند إلى قيم ثابتة بينما الديمقراطية قد تبيح ما يتناقض مع الفطرة',evidence:'وَأَمْرُهُمْ شُورَىٰ بَيْنَهُمْ — الشورى ٤٢: ٣٨'},
    en:{title:'Consultation Is an Islamic Methodology',desc:'Al-Ghazali affirms: Consultation (shura) is not merely a recommendation but a divine obligation. The Muslim ruler is bound to consult people of knowledge and expertise. Tyranny is categorically rejected in Islam.',misconception:'Islam does not know democracy',response:'Al-Ghazali affirms: Consultation preceded modern democracy by fourteen centuries. The difference is that shura is anchored in stable values, while democracy may permit what contradicts human nature',evidence:'And their affairs are conducted by mutual consultation — Ash-Shura 42:38'},
    fr:{title:'La Consultation, Méthode Islamique',desc:'Al-Ghazali affirme: La consultation (shura) n\'est pas une simple recommandation mais une obligation divine. Le dirigeant musulman est tenu de consulter les gens de savoir et d\'expertise. La tyrannie est catégoriquement rejetée en Islam.',misconception:'L\'Islam ne connaît pas la démocratie',response:'Al-Ghazali affirme: La consultation a précédé la démocratie moderne de quatorze siècles. La différence est que la shura repose sur des valeurs stables, tandis que la démocratie peut permettre ce qui contredit la nature humaine',evidence:'Et ceux dont les affaires se traitent par consultation entre eux — Ash-Shura 42:38'}
  },
  {
    id:4, emoji:'📚', category:'knowledge',
    ar:{title:'العلم فريضة',desc:'يؤكد الغزالي: الإسلام أول دين يجعل طلب العلم فريضة على كل مسلم ومسلمة. لم يفرّق بين علم ديني ودنيوي — فكل علم نافع عبادة.',misconception:'الإسلام عدو للعلم والتقدم',response:'يؤكد الغزالي: أول كلمة نزلت في القرآن "اقرأ". الحضارة الإسلامية قادت العالم علمياً لثمانية قرون. العلماء المسلمون أسسوا علوماً كاملة كالجبر والكيمياء والبصريات',evidence:'اقْرَأْ بِاسْمِ رَبِّكَ الَّذِي خَلَقَ — العلق ٩٦: ١'},
    en:{title:'Knowledge Is an Obligation',desc:'Al-Ghazali affirms: Islam is the first religion to make seeking knowledge obligatory for every Muslim, male and female. It did not distinguish between religious and worldly knowledge — every beneficial knowledge is worship.',misconception:'Islam is the enemy of science and progress',response:'Al-Ghazali affirms: The first word revealed in the Quran was "Read." Islamic civilization led the world scientifically for eight centuries. Muslim scholars founded entire disciplines like algebra, chemistry, and optics',evidence:'Read in the name of your Lord who created — Al-Alaq 96:1'},
    fr:{title:'Le Savoir Est une Obligation',desc:'Al-Ghazali affirme: L\'Islam est la première religion à rendre la quête du savoir obligatoire pour tout musulman et musulmane. Il n\'a pas distingué entre savoir religieux et profane — tout savoir bénéfique est un acte d\'adoration.',misconception:'L\'Islam est l\'ennemi de la science et du progrès',response:'Al-Ghazali affirme: Le premier mot révélé dans le Coran était « Lis ». La civilisation islamique a mené le monde scientifiquement pendant huit siècles. Les savants musulmans ont fondé des disciplines entières comme l\'algèbre, la chimie et l\'optique',evidence:'Lis au nom de ton Seigneur qui a créé — Al-Alaq 96:1'}
  },
  {
    id:5, emoji:'💰', category:'economics',
    ar:{title:'الاقتصاد الإسلامي',desc:'يؤكد الغزالي: الإسلام وضع نظاماً اقتصادياً متكاملاً يحارب الفقر والاحتكار. الزكاة ليست صدقة بل حق الفقير في مال الغني — نظام ضمان اجتماعي سبق العالم.',misconception:'الإسلام لا يملك نظرية اقتصادية',response:'يؤكد الغزالي: الإسلام حرّم الربا والاحتكار، وفرض الزكاة، ونظّم الملكية الخاصة والعامة. هذا نظام اقتصادي أخلاقي متكامل يوازن بين حرية الفرد ومصلحة المجتمع',evidence:'كَيْ لَا يَكُونَ دُولَةً بَيْنَ الْأَغْنِيَاءِ مِنكُمْ — الحشر ٥٩: ٧'},
    en:{title:'Islamic Economics',desc:'Al-Ghazali affirms: Islam established a complete economic system that fights poverty and monopoly. Zakat is not charity but the poor\'s right in the wealth of the rich — a social security system that preceded the modern world.',misconception:'Islam has no economic theory',response:'Al-Ghazali affirms: Islam prohibited usury and monopoly, mandated zakat, and regulated private and public ownership. This is a complete ethical economic system that balances individual freedom with community welfare',evidence:'So that wealth does not circulate only among the rich — Al-Hashr 59:7'},
    fr:{title:'L\'Économie Islamique',desc:'Al-Ghazali affirme: L\'Islam a établi un système économique complet qui combat la pauvreté et le monopole. La zakat n\'est pas une charité mais le droit du pauvre dans la richesse du riche — un système de sécurité sociale qui a précédé le monde moderne.',misconception:'L\'Islam n\'a pas de théorie économique',response:'Al-Ghazali affirme: L\'Islam a interdit l\'usure et le monopole, imposé la zakat, et réglementé la propriété privée et publique. C\'est un système économique éthique complet qui équilibre liberté individuelle et bien-être communautaire',evidence:'Afin que les richesses ne circulent pas seulement parmi les riches — Al-Hashr 59:7'}
  },
  {
    id:6, emoji:'👥', category:'society',
    ar:{title:'المساواة بين البشر',desc:'يؤكد الغزالي: الإسلام أعلن مساواة البشر جميعاً بغض النظر عن اللون والعرق والنسب. لا فضل لعربي على أعجمي إلا بالتقوى. هذه ثورة حقيقية في عالم كان يعبد الأصنام ويستعبد الضعفاء.',misconception:'الإسلام دين عنصري يفضل العرب',response:'يؤكد الغزالي: النبي أعلن في حجة الوداع: "لا فضل لعربي على أعجمي إلا بالتقوى". بلال الحبشي وسلمان الفارسي وصهيب الرومي كانوا من أقرب الصحابة',evidence:'يَا أَيُّهَا النَّاسُ إِنَّا خَلَقْنَاكُم مِّن ذَكَرٍ وَأُنثَىٰ وَجَعَلْنَاكُمْ شُعُوبًا وَقَبَائِلَ لِتَعَارَفُوا — الحجرات ٤٩: ١٣'},
    en:{title:'Equality Among All People',desc:'Al-Ghazali affirms: Islam declared the equality of all humans regardless of color, race, or lineage. No Arab has superiority over a non-Arab except through piety. This was a true revolution in a world that worshipped idols and enslaved the weak.',misconception:'Islam is a racist religion that favors Arabs',response:'Al-Ghazali affirms: The Prophet declared in his Farewell Sermon: "No Arab has superiority over a non-Arab except through piety." Bilal the Ethiopian, Salman the Persian, and Suhaib the Roman were among the closest companions',evidence:'O humanity, We created you from male and female and made you into nations and tribes that you may know one another — Al-Hujurat 49:13'},
    fr:{title:'L\'Égalité Entre Tous les Êtres Humains',desc:'Al-Ghazali affirme: L\'Islam a déclaré l\'égalité de tous les êtres humains sans distinction de couleur, de race ou de lignée. Aucun Arabe n\'a de supériorité sur un non-Arabe sauf par la piété. Ce fut une vraie révolution dans un monde qui adorait les idoles et asservissait les faibles.',misconception:'L\'Islam est une religion raciste qui favorise les Arabes',response:'Al-Ghazali affirme: Le Prophète a déclaré dans son Sermon d\'Adieu : « Aucun Arabe n\'a de supériorité sur un non-Arabe sauf par la piété. » Bilal l\'Éthiopien, Salman le Persan et Suhaib le Romain étaient parmi les plus proches compagnons',evidence:'Ô humanité, Nous vous avons créés d\'un mâle et d\'une femelle et Nous avons fait de vous des nations et des tribus pour que vous vous entre-connaissiez — Al-Hujurat 49:13'}
  },
  {
